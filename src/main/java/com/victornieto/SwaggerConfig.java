...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfo("ApiRest Demo", "Some custom description of API.", "API TOS", "Terms of service", "myeaddress@company.com", "License of API", "API license URL");
        return apiInfo;
    }
}
